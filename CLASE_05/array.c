...
//ver esto!
/*int array_maximo(  int* pArray, int limite,
                        int desde, int* pMaximo)
{
    int retorno=-1;
    int i;
...
int array_ordenamiento2(  int* pArray, int limite,
                         int orden)
{
    int retorno=-1;
    int j;
...
int array_swap(int* elementoUno,int* elementoDos){
    ...
    auxiliar=*elementoUno;
    *elementoUno=*elementoDos;
    *elementoDos=auxiliar;
